...
Answer: When using if statement to check the condition before doing something, we will use boolean algebra.

*   What are some examples of logical symbols in JavaScript?
    Answer: `&&`, `||`, `!`.

*   The Analytical Engine was never constructed. Why not?
    Answer: Because the inventor Babbage had conflicts with his chief engineer and inadequate funding.
